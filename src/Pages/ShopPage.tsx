...
export const ShopPage = () => {
  ...
  return (
    <div>
      <main className="w-full">
        <section className="h-[20rem] max-sm:h-auto relative font-Titillium-Web">
          ...
          <article className="absolute h-full w-full top-0 bg-banner-overlay ">
            <div className="h-full w-full flex flex-col max-sm:px-4 items-center justify-center">
              <h1 className="text-2xl text-center font-bold max-sm:text-lg max-md:text-xl text-white dark:text-gray-100">
                Redefine Comfort, Redefine Style
              </h1>

              <p className="text-lg max-sm:text-xs leading-[150%] text-gray-300 dark:text-gray-300 mt-4 max-sm:w-full w-[60%] text-center">
        ...
        <div className="mt-[2rem] px-[5rem] max-sm:px-[1rem] gap-8 grid grid-cols-[repeat(4,1fr)] max-sm:flex max-sm:flex-col  w-full">
      ...
      <div className="flex max-sm:flex-col gap-2 items-center justify-between w-full my-[4rem] px-[6rem] max-sm:px-[1rem] ">
