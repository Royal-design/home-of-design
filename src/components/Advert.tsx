...
export const Advert = () => {
  return (
    <div className="px-[6rem] max-sm:px-[1rem] mt-[2rem]  h-[10rem] max-sm:h-full w-full">
      <div className=" px-[2rem] bg-banner">
        <div className="flex items-center gap-[1rem]  h-full">
          ...
          <article className="ml-[10rem] max-sm:ml-0 flex flex-col gap-2 font-Titillium-Web">
